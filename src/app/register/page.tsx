...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50 flex items-center justify-center px-4 py-8">
      {/* Background decorations - Updated to match login */}
      ...
      <div className="relative w-full max-w-lg">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">Create your LASU Hostel account</p>
        </div>
        ...
        <Card className="backdrop-blur-sm bg-white/90 border border-slate-200/50 shadow-2xl shadow-slate-900/10">
          ...
          <form onSubmit={handleSubmit}>
            <CardContent className="space-y-6">
              {/* Account Type Selection - Updated colors */}
              ...
              {/* Full Name Field - Updated colors */}
              ...
              {/* Student ID Field - Updated colors */}
              {userType === "student" && (
              ...
              {/* Hostel Information - Updated colors */}
              {userType === "student" && (
                <div className="space-y-4 animate-in slide-in-from-top duration-300">
                  <div className="grid grid-cols-2 gap-4">
                    {/* Hostel Block */}
                    <div className="space-y-2">
                      <Label htmlFor="hostelBlock" className="text-sm font-semibold text-slate-700">
                        Hostel Block
                      </Label>
                      <Select value={hostelBlock} onValueChange={setHostelBlock} required>
                        <SelectTrigger className="h-12 bg-slate-50/50 border-slate-200 focus:border-blue-500 focus:ring-blue-500/20">
                ...
                >
                  ...
                  <div className="flex-1">
                    <Label className={`text-sm cursor-pointer ${
                      acceptTerms ? "text-green-700" : "text-slate-600"
                    }`}>
                      I agree to the{" "}
            ...
            <CardFooter className="flex flex-col space-y-4 pt-2">
              {/* Register Button - Updated colors */}
              <Button 
                type="submit" 
              ...
              {/* Divider - Updated colors */}
              <div className="relative">
                <div className="absolute inset-0 flex items-center">
                  <div className="w-full border-t border-slate-200"></div>
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white px-2 text-slate-500">Secure Registration</span>
                </div>
              </div>

              {/* Security Badge - Updated colors */}
